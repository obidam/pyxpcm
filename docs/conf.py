# -*- coding: utf-8 -*-
#
# pyxpcm documentation build configuration file, created by
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '.ipynb_checkpoints', '_ext', 'tempo_out']
